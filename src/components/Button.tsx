...
interface ButtonProps {
    ...
    svg?: boolean;
    svgname?: string;
    startColor?: string; // Added gradient start color
    endColor?: string; // Added gradient end color
...
const Button: React.FC<ButtonProps> = ({
                                                           ...
                                                           svg = false,
                                                           svgname,
                                                           startColor , // Default gradient start color
                                                           endColor , // Default gradient end color
        ...
        >
            {showLoading && loading ? (
                ...
                <>
                    ...
                    {iconName !== undefined && (
                        <Icon name={iconName} size={iconSize !== undefined ? iconSize : 16} color={iconColor !== undefined ? iconColor : 'white'} />
                    )}
                    {iconSecondName !== undefined && (
                        <Icon name={iconSecondName} size={iconSize !== undefined ? iconSize : 16} color={iconColor !== undefined ? iconColor : 'white'} />
                    )}
